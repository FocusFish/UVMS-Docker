...
import fish.focus.uvms.docker.validation.exchange.dto.PluginType;
import fish.focus.uvms.docker.validation.exchange.dto.SendingGroupLog;
import fish.focus.uvms.docker.validation.exchange.dto.SendingLog;
...
public class ExchangeSendingQueueRestIT extends AbstractRest {
    ...
    public void resendToEmailTest() throws Exception {
        ...
        assertSendingLogContainsUnsentMessageGuid(fish.focus.schema.exchange.plugin.types.v1.PluginType.EMAIL.name(), unsentMessageGuid);
