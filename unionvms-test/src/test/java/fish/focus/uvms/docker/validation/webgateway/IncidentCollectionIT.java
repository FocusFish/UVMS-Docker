...
import fish.focus.uvms.docker.validation.webgateway.dto.ExtendedIncidentLogDto;
import fish.focus.uvms.docker.validation.webgateway.dto.PollIdDto;
import fish.focus.uvms.docker.validation.webgateway.dto.PollInfoDto;
...
public class IncidentCollectionIT extends AbstractRest {
    ...
    public void updateParkedIncidentToInvalidStatus() {
        ...
        assertEquals(Integer.valueOf(500), error.code);
