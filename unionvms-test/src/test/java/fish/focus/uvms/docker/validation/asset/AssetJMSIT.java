...
public class AssetJMSIT {
	...
	public void testGetAssetByGuid() throws Exception {
		...
		fish.focus.wsdl.asset.types.Asset assetById = assetJMSHelper.getAssetById(asset.getId().toString(), AssetIdType.GUID);
	...
	public void testGetAssetByCFR() throws Exception {
		...
		fish.focus.wsdl.asset.types.Asset assetById = assetJMSHelper.getAssetById(asset.getCfr(), AssetIdType.CFR);
	...
	public void testGetAssetByIRCS() throws Exception {
		AssetDTO asset = AssetTestHelper.createTestAsset();
		fish.focus.wsdl.asset.types.Asset assetById = assetJMSHelper.getAssetById(asset.getIrcs(), AssetIdType.IRCS);
	...
	public void testGetAssetByMMSI() throws Exception {
		AssetDTO asset = AssetTestHelper.createTestAsset();
		fish.focus.wsdl.asset.types.Asset assetById = assetJMSHelper.getAssetById(asset.getMmsi(), AssetIdType.MMSI);
