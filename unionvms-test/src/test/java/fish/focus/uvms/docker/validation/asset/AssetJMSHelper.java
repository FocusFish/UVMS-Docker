...
public class AssetJMSHelper extends AbstractHelper implements AutoCloseable {
    ...
    public fish.focus.uvms.asset.client.model.AssetDTO createBasicAsset() {
        fish.focus.uvms.asset.client.model.AssetDTO asset = new fish.focus.uvms.asset.client.model.AssetDTO();
